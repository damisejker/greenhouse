...
// Calculate the end dates for each cycle
...
echo "<br><br><b>$rastenie </b>

	<br>2 цикл: $secondcycle
	<br>3 цикл: $thirdcycle
	<br>4 цикл: $fourthcycle
	<br>5 цикл: $fifthcycle
	<br>6 цикл: $sixthcycle
	";

// Execute the update query if it's set
